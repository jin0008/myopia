      ...
      <GuideContainer>
        ...
        <Section>
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step2_login.png"
              alt="Login button"
            />
          </Step>
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step3_signup_form.png"
              alt="Sign up form"
            />
          </Step>
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step4_user_type.png"
              alt="User type selection"
            />
          </Step>
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step5_register.png"
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step6_hospital_setting.png"
              alt="Hospital settings"
            />
            <StepImage
              src="/images/manual/step7_hospital_admin.png"
              alt="Hospital admin"
            />
            ...
            <StepImage
              src="/images/manual/step8_register_hospital.png"
              alt="Hospital registration form"
            />
          </Step>
        </Section>
        ...
        <Section>
          <SectionTitle>
            2. {isKorean ? "사용방법" : "Usage Instructions"}
          </SectionTitle>
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step9_patient_add_1.png"
              alt="Add new patient"
            />
          </Step>
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step9_patient_add_2.png"
              alt="Patient data form"
            />
          </Step>
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step10_patient_navigate.png"
              alt="Patient card navigation"
            />
          </Step>
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step11_measure_add_1.png"
              alt="Measurement entry 1"
            />
            <StepImage
              src="/images/manual/step11_measure_add_2.png"
              alt="Measurement entry 2"
            />
            <StepContent style={{ marginTop: "16px" }}>
              {isKorean
          ...
          <Step>
            ...
            <StepImage
              src="/images/manual/step12_treatment_add.png"
              alt="Treatment entry"
            />
          </Step>
